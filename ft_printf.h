...
/*   Updated: 2021/01/21 04:59:35 by pllucian         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void			ft_parse_format(const char *format, va_list ap, \
													t_struct *flags);
void			ft_init_flags(t_struct *flags);
const char		*ft_parse_flags(const char *format, va_list ap, \
													t_struct *flags);
...
const char		*ft_flag_precision(const char *format, va_list ap, \
													t_struct *flags);
